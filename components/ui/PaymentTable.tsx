...
const STATUS_MAP: Record<PaymentItem['paymentStatus'], { label: string; color: string; bg: string }> = {
  PAID:             { label: '결제완료',  color: 'var(--ph-primary)',  bg: 'var(--ph-secondary)' },
  REFUNDING:        { label: '환불 신청 중', color: 'var(--ph-red)',      bg: 'rgba(217,45,32,0.10)' },
  PARTIAL_REFUNDED: { label: '부분 환불', color: 'var(--ph-red)',      bg: 'rgba(217,45,32,0.10)' },
  ALL_REFUNDED:     { label: '환불 완료', color: 'var(--ph-gray-600)', bg: 'var(--ph-gray-100)' },
};
