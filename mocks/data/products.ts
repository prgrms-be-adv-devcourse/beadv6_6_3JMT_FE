...
export const PRODUCTS: Product[] = [
  {
    id: 1, title: '사진 같은 제품 목업 생성기', cat: 'image', icon: 'image',
    model: 'Midjourney v6', price: 5900, rating: 4.9, sales: 1240,
  ...
  {
    id: 2, title: '전환율 높이는 랜딩 카피 작성', cat: 'writing', icon: 'pen-line',
    model: 'GPT-4o', price: 4900, originalPrice: 7900, rating: 4.8, sales: 980,
  ...
  {
    id: 3, title: '리액트 컴포넌트 리팩터링 도우미', cat: 'coding', icon: 'code-xml',
    model: 'Claude 3.5', price: 7900, rating: 5.0, sales: 612,
  ...
  {
    id: 4, title: '30일 SNS 콘텐츠 캘린더', cat: 'marketing', icon: 'megaphone',
    model: 'GPT-4o', price: 3900, originalPrice: 5900, rating: 4.7, sales: 2310,
    seller: '프롬트랩', sellerId: 'user-2', badge: '베스트',
  ...
  {
    id: 5, title: '친절한 CS 챗봇 페르소나', cat: 'chatbot', icon: 'message-circle',
    model: 'Claude 3.5', price: 6900, rating: 4.9, sales: 540,
  ...
  {
    id: 6, title: '엑셀 데이터 인사이트 요약', cat: 'data', icon: 'bar-chart-3',
    model: 'GPT-4o', price: 0, rating: 4.6, sales: 430,
  ...
  {
    id: 7, title: '감성 일러스트 캐릭터 시트', cat: 'image', icon: 'image',
    model: 'Midjourney v6', price: 4500, rating: 4.8, sales: 870,
  ...
  {
    id: 8, title: '유튜브 스크립트 후킹 오프닝', cat: 'writing', icon: 'pen-line',
    model: 'GPT-4o', price: 0, rating: 4.7, sales: 1520,
    seller: '프롬트랩', sellerId: 'user-2', badge: '신규',
  ...
  {
    id: 9, title: 'A/B 테스트 광고 카피 생성기', cat: 'marketing', icon: 'megaphone',
    model: 'GPT-4o', price: 4200, rating: 4.6, sales: 780,
    seller: '프롬트랩', sellerId: 'user-2',
  ...
  {
    id: 10, title: '코드 리뷰 자동화 봇', cat: 'coding', icon: 'code-xml',
    model: 'Claude 3.5', price: 8900, rating: 4.9, sales: 310,
    seller: '판매자', sellerId: 'user-3',
  ...
  {
    id: 11, title: '여행 일정 플래너', cat: 'chatbot', icon: 'message-circle',
    model: 'GPT-4o', price: 2900, rating: 4.5, sales: 1100,
    seller: '토크봇', sellerId: 'seller-5',
  ...
  {
    id: 12, title: '판매 데이터 주간 리포트', cat: 'data', icon: 'bar-chart-3',
    model: 'GPT-4o', price: 3500, rating: 4.7, sales: 290,
    seller: '데이터핀', sellerId: 'seller-6',
  ...
  {
    id: 13, title: '로고 디자인 컨셉 생성기', cat: 'image', icon: 'image',
    model: 'Midjourney v6', price: 6500, rating: 4.8, sales: 760,
  ...
  {
    id: 14, title: '인스타그램 릴스 썸네일 생성', cat: 'image', icon: 'image',
    model: 'DALL·E 3', price: 3200, rating: 4.6, sales: 530,
  ...
  {
    id: 15, title: '이메일 뉴스레터 작성 도우미', cat: 'writing', icon: 'pen-line',
    model: 'GPT-4o', price: 4400, rating: 4.7, sales: 810,
  ...
  {
    id: 16, title: '보도자료 초안 자동 작성', cat: 'writing', icon: 'pen-line',
    model: 'Claude 3.5', price: 5500, rating: 4.9, sales: 340,
  ...
  {
    id: 17, title: 'SQL 쿼리 최적화 도우미', cat: 'coding', icon: 'code-xml',
    model: 'GPT-4o', price: 6800, rating: 4.8, sales: 420,
  ...
  {
    id: 18, title: 'API 문서 자동 생성기', cat: 'coding', icon: 'code-xml',
    model: 'Claude 3.5', price: 7200, rating: 4.7, sales: 265,
  ...
  {
    id: 19, title: '경쟁사 분석 리포트 생성기', cat: 'marketing', icon: 'megaphone',
    model: 'GPT-4o', price: 5100, rating: 4.6, sales: 630,
  ...
  {
    id: 20, title: '카카오톡 채널 메시지 작성', cat: 'marketing', icon: 'megaphone',
    model: 'GPT-4o', price: 2900, rating: 4.5, sales: 940,
  ...
  {
    id: 21, title: '멀티턴 고객 응대 시나리오', cat: 'chatbot', icon: 'message-circle',
    model: 'Claude 3.5', price: 7500, rating: 4.8, sales: 380,
    seller: '토크봇', sellerId: 'seller-5',
  ...
  {
    id: 22, title: '온보딩 FAQ 챗봇 구축', cat: 'chatbot', icon: 'message-circle',
    model: 'GPT-4o', price: 4800, rating: 4.6, sales: 510,
  ...
  {
    id: 23, title: '마케팅 대시보드 인사이트 요약', cat: 'data', icon: 'bar-chart-3',
    model: 'GPT-4o', price: 4100, rating: 4.7, sales: 355,
    seller: '데이터핀', sellerId: 'seller-6',
  ...
  {
    id: 24, title: '고객 리뷰 감성 분석기', cat: 'data', icon: 'bar-chart-3',
    model: 'Claude 3.5', price: 5800, rating: 4.9, sales: 190,
